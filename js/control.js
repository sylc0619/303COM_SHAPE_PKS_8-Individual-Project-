...
$(document).ready(function() {
            ...
            success: function(r) {
                ...
                if (r == "Login_Success") {
                    ...
                    $(".alert-danger")
                        ...
                        .text("The Username or Password you typed is incorrect")
                        .show();
            ...
            if ($("#password").val() != "" || $("#confirm").val() != "") {
                if ($("#password").val() == $("#confirm").val()) {
                    ...
                    $("#password")
                        ...
                        .html("Password and Confirm Password Does Not Matching")
                        .show();
                    $("#confirm")
                        .siblings(".invalid-feedback")
                        .html("Password and Confirm Password Does Not Matching")
    ...
    $("#register").click(function() {
        ...
        if (username == "") {
            $("#username")
                .siblings(".invalid-feedback")
                .html("Please fill in this field")
                .show();
        } else {
        ...
        if (password == "") {
            ...
            if (password.length < 5) {
                ...
                $("#password")
                    .siblings(".invalid-feedback")
                    .html("Password too short at least 5.")
                    .show();
            } else {
                passwordlength = true;
            }
        ...
        if ($("#privacy").not(":checked").length) {
            $("#privacy")
                .siblings(".invalid-feedback")
                .html("Please accept the terms to proceed.")
                .show();
        } else {
    ...
    $(".slider-product").on(
        ...
        function(e) {
            console.log("HI" + $(".owl-item ")[1].offsetHeight);
            $(".productARModel").height($(".owl-item ")[1].offsetHeight);
        }
    );
