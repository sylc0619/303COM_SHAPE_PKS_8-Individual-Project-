var app = new Vue({
    ...
    data: {
        ...
        product: {
            ...
            Colors: ["Red", "Yellow"],
            Price: 115,
            Image: "product-010-A.webp",
            Images: ["product-010-A.webp", "product-010-B.webp", "product-010-C.webp"],
            Model: "product3D-A",
        },
    ...
    methods: {
        setImageColor(color) {
            ...
            console.log(color)
            if (color == "Red") {
                $("#hair_Yellow").removeClass("active");
                $("#hair_Red").addClass("active");
            } else if (color == "Yellow") {
                $("#hair_Red").removeClass("active");
                $("#hair_Yellow").addClass("active");
            }
        },
    ...
    created() {
        ...
        this.showImage=true;
        setTimeout(()=>{$(".productARModel").height($(".owl-item ")[1].offsetHeight);
    },500 )
        ...
        $.ajax({
            ...
            success: (data, status, xhr) => {
                ...
                if (!!this.product.Colors && this.product.Colors.length > 0) {
                    this.colorList = this.product.Colors;
                    this.setImageColor(this.product.Colors[0]);
                } else {
                    //TODO if no Colors in DB, what should do ?
                }
            },
        });
    ...
    mounted() {
        this.$nextTick(function() {
            ...
            setTimeout(() => {
                ...
                $(".testing-btn").click(function(event) {
                    $(".show-ar").toggleClass("active");
                });
